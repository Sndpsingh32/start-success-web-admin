...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | StartSuccess Admin - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for StartSuccess Admin - React.js Tailwind CSS Admin Dashboard Template"
      />
