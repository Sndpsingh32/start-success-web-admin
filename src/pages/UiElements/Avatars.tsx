...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | StartSuccess Admin - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for StartSuccess Admin - React.js Tailwind CSS Admin Dashboard Template"
      />
